					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Panaya Dashboard",
									"targetURL": "#panayanexa-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"panayanexa-display": {
								"semanticObject": "panayanexa",
								"action": "display",
								"description": "Panaya Dashboard",
								"title": "Panaya Dashboard",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=panaya.nexa",
									"url": sap.ui.require.toUrl("panaya/nexa")
								}
							}
						}
					}
